...
namespace Garden
{
    public class WeatherService : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            // In debug mode, time-of-day is controlled by the debug panel dropdown.
            // In normal mode, track time-of-day from GameTime so it progresses naturally.
            if (!useDebugOverride && UpdateTimeOfDay(CurrentWeather, GameTime.Now, out var updated))
            {
