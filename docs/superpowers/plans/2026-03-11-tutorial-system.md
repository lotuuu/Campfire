        ...
        private void ShowHintForStep(int step)
        {
            ...
            switch (step)
            {
                case StepPlantFirst:
                    ...
                    break;
                case StepWaterFirst:
                    tutorialUI?.ShowHint("Water your plant for a better harvest! You can water crops every 2 hours");
                    HighlightHexCell(0);
                    break;
                case StepHarvestFirst:
                ...
                case StepWateringOutcome:
                    ...
                    break;
                case StepBuildHouse:
                    tutorialUI?.ShowHint("Build a Mallum House to get more helpers. Buildings cost mana generated by your fire");
                    HighlightFlameHex();
                    break;
                case StepSendOnQuest:
                    ...
                    break;
                case StepPlantCressSpeedPotion:
                    tutorialUI?.ShowHint("Plant Cress and use a Speed Potion to grow it faster. Take a look at the recipe first!");
                    HighlightHexCell(0);
                    break;
